...
public class CreateCourse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Carrera a la que pertenece:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int teacherId = (Integer) jSpinner1.getValue();
        String degree = jTextField2.getText();
        Course course = new Course(name,teacherId);
        Main.Api.addCourse(course, degree);
        
        Teacher teacher = Main.Api.getTeacherById(teacherId);
        teacher.addCourse( Main.Api.getLatestAddedCourse() );
        Main.Api.addCourseToTeacher(teacher);
